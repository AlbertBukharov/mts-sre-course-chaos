...
5. Анализ результатов: Ожидаемые и реальные результаты в целом совпали.

Выключение одной из etcd-нод
